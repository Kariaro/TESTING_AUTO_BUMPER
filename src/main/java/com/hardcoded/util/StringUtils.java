...
public final class StringUtils {
	// $auto-bumper-line
	public static final String A_TEST = "0.0.15";
	
	// $auto-bumper-line
	public static final String B_TEST = "0.0.15";
	
	// Nothing
	public static final String C_TEST = "0.0.12";
	
	
	public static final String B = "0.0.15"; // $auto-bumper
	public static final String C = "0.0.1";
	public static final String D = "0.0.15"; // $auto-bumper
	public static final String E = "0.0.1";
	public static final String F = "0.0.15"; // $auto-bumper
